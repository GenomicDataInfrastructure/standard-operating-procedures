...
- [GDI-SOP0012_withdraw_dataset_from_node_allele_frequency_beacon.md](../node-specific/GDI-SOP0012_withdraw_dataset_from_node_allele_frequency_beacon.md) - Node-specific SOP template describing how a node's allele frequency beacon should dataset should be removed.
