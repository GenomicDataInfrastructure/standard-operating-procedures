...
- [``GDI-SOP0014_add-datasets-metadata-to-node-beacon.md``](sops/node-specific/GDI-SOP0014_add-datasets-metadata-to-node-beacon.md) - Add dataset’s metadata to Node beacon.
