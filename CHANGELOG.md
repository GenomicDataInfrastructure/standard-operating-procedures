...
- [``GDI-SOP0007_SOP-template-creation.md``](sops/european-level/GDI-SOP0007_SOP-template-creation.md) - Annual periodic review (https://github.com/GenomicDataInfrastructure/standard-operating-procedures/pull/70).
