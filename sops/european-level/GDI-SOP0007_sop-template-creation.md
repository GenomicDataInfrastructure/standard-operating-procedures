...
### 5. Scope
This SOP breaks the process of creating an SOP down into detailed steps covering all stages from the initial SOP request by any member of GDI, review of the request, the crucial role of GDI's Operations Committee in steering the SOP creation process, the selection of authors and reviewers as well as the approval and authorisation of the SOP prior to release of the SOP. The output of this SOP will be the finalised document added to the repository.
